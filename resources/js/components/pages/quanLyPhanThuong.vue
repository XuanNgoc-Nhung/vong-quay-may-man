                ...
                <div class="table-responsive">
                    <table class="datatable table-bordered table hover-table">
                        ...
                        >
                            ...
                            <td class="text-center">{{ item.amount - item.used }}</td>
                            <td class="text-center">{{ item.created_at }}</td>
                            <td class="text-center">
<!--                                <el-button :disabled="item.status==1" size="mini" type="warning">Sửa</el-button>-->
                                <el-button :disabled="item.status==1" @click.prevent="xoaPhanThuong(item)" size="mini" type="danger">Xoá</el-button>
                            </td>
                        </tr>
                        </tbody>
                        <tbody v-else>
        ...
        <el-row :gutter="24">
            <el-col :span="24">
                ...
                <el-dialog
                    ...
                    <el-row :gutter="24">
                        <el-col :span="24">
                            <el-form label-position="top" label-width="100px" :rules="rulesSearch" ref="formThemPhanThuong"
